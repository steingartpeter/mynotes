    ...
    return Column(
      children: [
        TextField(
          ...
          decoration:
              const InputDecoration(hintText: 'Enter your email please'),
        ),
        const SizedBox(
          height: 15.0,
        ),
          ...
          onPressed: () async {
            ...
            try {
              ...
              if (e.code == 'weak-password') {
                print('Pasword is not secure, please choose a longer one!');
                //print('E: {$e}');
              } else if (e.code == 'email-already-in-use') {
                print('This email is already taken, use diffrent one please!');
                //print('E: {$e}');
